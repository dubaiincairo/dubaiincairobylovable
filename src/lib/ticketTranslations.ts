...
• What actually happened? (Include any error codes or messages shown)`,
    ...
    videoUploadSubtext: "Drop video or click to upload (Max 15MB) · For larger clips, use Loom or Drive link",
...
• ماذا حدث فعلياً؟ (مع ذكر أي رسائل خطأ ظهرت على الشاشة)`,
    ...
    videoUploadSubtext: "اسحب الفيديو أو اضغط للاختيار (حتى 15 ميجابايت) · للتسجيلات الأكبر يرجى وضع رابط سحابي (Loom / Drive)",
