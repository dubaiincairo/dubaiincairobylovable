...
export const contentRegistry: ContentField[] = [
  ...
  // works.
  { section: "clients", key: "client_logo_1_name",  label: "Logo 1 — Brand Name (alt text)",  defaultValue: "Samsung" },
  { section: "clients", key: "client_logo_1_url",   label: "Logo 1 — File (SVG or transparent PNG recommended)",   defaultValue: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/samsung.svg", type: "upload" },
  { section: "clients", key: "client_logo_2_name",  label: "Logo 2 — Brand Name (alt text)",  defaultValue: "Unilever" },
  { section: "clients", key: "client_logo_2_url",   label: "Logo 2 — File",   defaultValue: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/unilever.svg", type: "upload" },
  { section: "clients", key: "client_logo_3_name",  label: "Logo 3 — Brand Name (alt text)",  defaultValue: "Vodafone" },
  { section: "clients", key: "client_logo_3_url",   label: "Logo 3 — File",   defaultValue: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/vodafone.svg", type: "upload" },
  { section: "clients", key: "client_logo_4_name",  label: "Logo 4 — Brand Name (alt text)",  defaultValue: "Huawei" },
  { section: "clients", key: "client_logo_4_url",   label: "Logo 4 — File",   defaultValue: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/huawei.svg", type: "upload" },
  { section: "clients", key: "client_logo_5_name",  label: "Logo 5 — Brand Name (alt text)",  defaultValue: "PepsiCo" },
  { section: "clients", key: "client_logo_5_url",   label: "Logo 5 — File",   defaultValue: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/pepsi.svg", type: "upload" },
  { section: "clients", key: "client_logo_6_name",  label: "Logo 6 — Brand Name (alt text)",  defaultValue: "Orange" },
  { section: "clients", key: "client_logo_6_url",   label: "Logo 6 — File",   defaultValue: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/orange.svg", type: "upload" },
