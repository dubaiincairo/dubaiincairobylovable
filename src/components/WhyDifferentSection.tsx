...
const edges = [
  ...
  { icon: BarChart3, title: "Results You Can Measure", desc: "Every campaign comes with clear KPIs, transparent reporting, and data-backed insights — so you always know exactly what your investment is delivering." },
];
