      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-7">
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <RichText
              html={get("footer_tagline", "From Dubai to Cairo, we transferred the scope, the challenges, and the quality.")}
              className="mt-2 text-xs italic text-muted-foreground max-w-md leading-relaxed"
            />
