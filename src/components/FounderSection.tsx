...
const FounderSection = () => {
  ...
  return (
    <section id="team" className="relative py-6 md:py-10 px-6 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-10 lg:gap-14 items-center">
